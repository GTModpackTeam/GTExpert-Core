...
public class MTELargeGasCollector extends GCYMRecipeMapMultiblockController {

    public MTELargeGasCollector(ResourceLocation metaTileEntityId) {
    ...
    public @NotNull MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MTELargeGasCollector(metaTileEntityId);
    }
