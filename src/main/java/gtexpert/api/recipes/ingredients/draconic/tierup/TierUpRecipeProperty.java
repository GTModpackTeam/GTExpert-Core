package gtexpert.api.recipes.ingredients.draconic.tierup;
...
public class TierUpRecipeProperty extends RecipeProperty<ToolUpgradeRecipe> {
    ...
    public void drawInfo(Minecraft minecraft, int x, int y, int color, Object value) {
        ...
        minecraft.fontRenderer.drawString(I18n.format("recipemap.draconic_fusion_tier_up.property.2"), x, y + 10, color);
    }
}
