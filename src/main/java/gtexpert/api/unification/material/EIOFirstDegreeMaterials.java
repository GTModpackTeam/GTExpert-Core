...
public class EIOFirstDegreeMaterials {
    ...
    public static void init() {
        ...
        // Crude Steel
        CRUDE_STEEL = new Material.Builder(25013, "crude_steel")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0x8C8682)
                .iconSet(MaterialIconSet.ROUGH)
        ...
        // Crystalline Alloy
        CRYSTALLINE_ALLOY = new Material.Builder(25014, "crystalline_alloy")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0x9FE4E4)
                .iconSet(MaterialIconSet.SHINY)
        ...
        // Melodic Alloy
        MELODIC_ALLOY = new Material.Builder(25015, "melodic_alloy")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0xA877A8)
                .iconSet(MaterialIconSet.SHINY)
        ...
        // Stellar Alloy
        STELLAR_ALLOY = new Material.Builder(25016, "stellar_alloy")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0xDBDECC)
                .iconSet(MaterialIconSet.SHINY)
        ...
        CRYSTALLINE_PINK_SLIME = new Material.Builder(25017, "crystalline_pink_slime")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0xE79EDB)
                .iconSet(MaterialIconSet.SHINY)
        ...
        // Energetic Silver
        ENERGETIC_SILVER = new Material.Builder(25018, "energetic_silver")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0x598DB3)
                .iconSet(MaterialIconSet.SHINY)
        ...
        // Vivid Alloy
        VIVID_ALLOY = new Material.Builder(25019, "vivid_alloy")
                .dust().ingot().fluid()
                .fluidTemp(1200)
                .color(0x469BB1)
                .iconSet(MaterialIconSet.SHINY)
