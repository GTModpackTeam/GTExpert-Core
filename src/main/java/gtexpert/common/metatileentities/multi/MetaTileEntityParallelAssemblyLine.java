...
public class MetaTileEntityParallelAssemblyLine extends GCYMRecipeMapMultiblockController {

    public MetaTileEntityParallelAssemblyLine(ResourceLocation metaTileEntityId) {
    ...
    public @NotNull MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityParallelAssemblyLine(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @NotNull List<String> tooltip,
                               boolean advanced) {
        tooltip.add(I18n.format("gtexpert.machine.parallel_assembly_line.tooltip.1"));
