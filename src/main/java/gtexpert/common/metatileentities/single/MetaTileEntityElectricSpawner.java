...
public class MetaTileEntityElectricSpawner extends SimpleMachineMetaTileEntity {
    ...
    protected ModularUI.Builder createGuiTemplate(EntityPlayer player) {
        ...
        builder.widget(new ToggleButtonWidget(leftButtonStartX, 62 + yOffset, 18, 18,
            ...
            public void drawInForeground(int mouseX, int mouseY) {
                ...
                List<String> hoverList = Arrays.asList(GTUtility.getForwardNewLineRegex().split(I18n.format(getSpawnModeTranslationKey(isPressed))));
        ...
        builder.widget(new ImageWidget(leftButtonStartX, 62 + yOffset, 16, 16) {
            ...
            public void drawInForeground(int mouseX, int mouseY) {
                ...
                List<String> hoverList = Arrays.asList(GTUtility.getForwardNewLineRegex().split(I18n.format("gtexpert.gui.needs_redstone")));
                // Use this after GTUtility cleanup
    ...
    private ModularUI.Builder createUITemplate(DoubleSupplier progressSupplier, IItemHandlerModifiable importItems, IItemHandlerModifiable exportItems, int yOffset) {
        ...
        builder.widget(new RecipeProgressWidget(progressSupplier, 78, 23 + yOffset, 20, 20, GuiTextures.PROGRESS_BAR_ARROW, ProgressWidget.MoveType.HORIZONTAL, null) {
    ...
    private void addSlot(ModularUI.Builder builder, int x, int y, int slotIndex, IItemHandlerModifiable itemHandler, boolean isOutputs) {
        builder.widget(new SlotWidget(itemHandler, slotIndex, x, y, true, !isOutputs).setBackgroundTexture(getOverlaysForSlot(isOutputs, slotIndex == itemHandler.getSlots() - 1)));
    }
