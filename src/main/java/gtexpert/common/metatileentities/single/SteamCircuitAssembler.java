...
public class SteamCircuitAssembler extends SteamMetaTileEntity {
    ...
    public SteamCircuitAssembler(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, GTERecipeMaps.STEAM_CIRCUIT_ASSEMBLER_RECIPES, Textures.ASSEMBLER_OVERLAY,
                isHighPressure);
    }
    ...
    public ModularUI createUI(EntityPlayer player) {
        return createUITemplate(player)
                ...
                .progressBar(workableHandler::getProgressPercent, 77, 34, 20, 20,
                        GTEGuiTextures.PROGRESS_BAR_STEAM_CIRCUIT_ASSEMBLER_STEAM.get(isHighPressure),
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("gtexpert.machine.steam_circuit_assembler.tooltip"));
        tooltip.add(I18n.format("gtexpert.machine.steam_circuit_assembler.tooltip.1"));
    }
