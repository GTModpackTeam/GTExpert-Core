...
public class GTEMetaTileEntities {
    ...
    private static void registerGTESimpleMetaTileEntity(SimpleMachineMetaTileEntity[] machines,
                                                        int startId,
                                                        String name,
                                                        RecipeMap<?> map,
        ...
        registerGTESimpleMetaTileEntity(machines, startId, name, map, texture, hasFrontFacing, GTUtility::gregtechId,
                tankScalingFunction);
    }
    ...
    private static void registerGTESimpleMetaTileEntity(SimpleMachineMetaTileEntity[] machines,
                                                        ...
                                                        ICubeRenderer texture,
                                                        boolean hasFrontFacing) {
        registerGTESimpleMetaTileEntity(machines, startId, name, map, texture, hasFrontFacing,
                GTUtility.defaultTankSizeFunction);
    }

    public static void registerGTESimpleMetaTileEntity(SimpleMachineMetaTileEntity[] machines,
                                                       int startId,
                                                       String name,
                                                       RecipeMap<?> map,
                                                       ICubeRenderer texture,
