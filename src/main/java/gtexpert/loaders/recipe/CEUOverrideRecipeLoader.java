...
public class CEUOverrideRecipeLoader {
    ...
    private static void blocks() {
        ...
        ModHandler.addShapedRecipe("gregtech.machine.battery_buffer.uv.4", MetaTileEntities.BATTERY_BUFFER[0][UHV].getStackForm(),
                "WTW", "WMW",
        ...
        ModHandler.addShapedRecipe("gregtech.machine.battery_buffer.uv.8", MetaTileEntities.BATTERY_BUFFER[1][UHV].getStackForm(),
                "WTW", "WMW",
                'M', MetaTileEntities.HULL[UHV].getStackForm(),
        ...
        ModHandler.addShapedRecipe("gregtech.machine.battery_buffer.uv.16", MetaTileEntities.BATTERY_BUFFER[2][UHV].getStackForm(),
                "WTW", "WMW",
                'M', MetaTileEntities.HULL[UHV].getStackForm(),
        ...
        ModHandler.addShapedRecipe("gregtech.machine.turbo_charger.uv", MetaTileEntities.CHARGER[UHV].getStackForm(),
                "QTQ", "QMQ", "WCW",
                'M', MetaTileEntities.HULL[UHV].getStackForm(),
